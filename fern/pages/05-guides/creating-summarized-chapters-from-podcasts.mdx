...
The [Auto Chapters](../03-audio-intelligence/auto-chapters.mdx) model summarizes audio data over time into chapters. Chapters makes it easy for users to navigate and find specific information.
...
If you need more fine-grained control than Auto Chapters offers, you can use AssemblyAI's [Summarization model](../03-audio-intelligence/summarization.mdx) to customize the complexity of your summary.
