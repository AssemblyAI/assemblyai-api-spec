...
config = aai.TranscriptionConfig(
    speech_model=[aai.SpeechModel.universal_3_pro, aai.SpeechModel.universal_2],
...
const params = {
  audio: audioFile,
  speech_model: [SpeechModel.Universal3Pro, SpeechModel.Universal2],
  language_detection: true,
  webhook_url: "https://example.com/webhook",
};
...
{
var data = new { audio_url = audioUrl, speech_models = new[] { "universal-3-pro", "universal-2" }, language_detection = true, webhook_url = "https://example.com/webhook" };
