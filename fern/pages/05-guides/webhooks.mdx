...
<Note>
This guide covers webhooks for [pre-recorded audio transcription](/docs/speech-to-text/pre-recorded-audio). Webhooks are not available for [streaming audio transcription](/docs/speech-to-text/universal-streaming).
</Note>
