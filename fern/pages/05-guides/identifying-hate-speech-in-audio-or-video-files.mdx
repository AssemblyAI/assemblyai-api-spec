...
Our [Content Moderation](../03-audio-intelligence/content-moderation.mdx) model can help you ensure that your content is safe and appropriate for all audiences.
...
For more information, see [Content Moderation model documentation](../03-audio-intelligence/content-moderation.mdx#understanding-the-response) and [API reference](https://assemblyai.com/docs/api-reference/transcripts).
