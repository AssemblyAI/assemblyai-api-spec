---
title: 'LeMUR Task Endpoint Action Items'
---




# LeMUR Task Endpoint Action Items

This Colab will demonstrate how to use AssemblyAI's [LeMUR](https://www.assemblyai.com/blog/lemur/) (Leveraging Large Language Models to Understand Recognized Speech) framework to create action items from a transcript using the Task endpoint.
