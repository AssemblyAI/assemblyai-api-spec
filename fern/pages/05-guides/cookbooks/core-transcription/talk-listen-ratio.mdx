---
title: 'Calculate Talk / Listen Ratio'
---
...
This guide will show you how to use AssemblyAI's API to calculate the talk/listen ratio of speakers in a transcript. The following code uses the [Python SDK]([automatic-language-detection-route-default-language-js.md](https://github.com/AssemblyAI/assemblyai-python-sdk)).
