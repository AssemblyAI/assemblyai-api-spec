...
Set all of your audio configurations and global variables. Make sure that you have the parameter `formatted_finals` set to `True` and a global variable `conversation_data` set to an empty string `""`.
