...
When applying the [Speaker Diarization model](../02-speech-to-text/speaker-diarization.mdx), the transcription not only contains the text but also includes speaker labels, enhancing the overall structure and organization of the output.
...
For more information, see the [Speaker Diarization model documentation](../02-speech-to-text/speaker-diarization.mdx#specifying-the-number-of-speakers) or see the [API reference](https://assemblyai.com/docs/api-reference/transcripts).
