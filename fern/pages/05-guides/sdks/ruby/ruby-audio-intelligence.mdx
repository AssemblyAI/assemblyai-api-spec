...
<Warning title="Deprecation Notice">
  ...
  Going forward, see the [Ruby Getting Started page](/docs/getting-started/transcribe-an-audio-file/ruby) and any of our Audio Intelligence pages for information on how to integrate with our API directly.
