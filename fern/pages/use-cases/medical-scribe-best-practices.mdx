...
- **Universal-Streaming** — Default streaming model with low latency (~300ms), supports English and multilingual
- **Universal-3 Pro Streaming** (`u3-rt-pro`) — Highest accuracy streaming model, supports prompting. Best for medical scribes that demand the highest quality
