...
description: Best practices for building voice agents with AssemblyAI streaming speech-to-text.
_/}
...
- Pre-built integrations with LiveKit, Pipecat
...
CONNECTION_PARAMS = {
    ...
    "min_turn_silence": 160,  # ms after confident EOT
...
- [Building a Voice Agent with LiveKit and AssemblyAI (Universal-3 Pro)](/docs/voice-agents/livekit-u3-rt-pro)
- [Building a Voice Agent with Pipecat and AssemblyAI (Universal-3 Pro)](/docs/voice-agents/u3pro-pipecat)
...
latency_optimized_params = {
    ...
    "min_turn_silence": 160,  # Minimal silence required
...
Note that we recommend testing the end of turn confidence for your use case. You can find our [guide on turn detection here](https://www.assemblyai.com/docs/streaming/universal-streaming/turn-detection).
...
AssemblyAI includes VAD in the model. You can substitute Universal-Streaming entirely for VAD by adjusting `min_turn_silence`, though this increases latency until the silence threshold has passed. This is recommended most for custom builds where a voice agent orchestrator is not managing the VAD for you.
...
| --------------------------------------------------------------------------------------------------------- | ------ | ---------- | ------------------------ |
| [Aggressive](https://www.assemblyai.com/docs/streaming/universal-streaming/turn-detection#aggressive)     | ~200ms | ~500ms     | Quick confirmations, IVR |
| [Balanced](https://www.assemblyai.com/docs/streaming/universal-streaming/turn-detection#balanced)         | ~300ms | ~800ms     | Most conversations       |
| [Conservative](https://www.assemblyai.com/docs/streaming/universal-streaming/turn-detection#conservative) | ~400ms | ~1200ms    | Complex instructions     |

## How Can I Use Turn Detection in My Voice Agent?

### Understanding Turn Detection

Universal-Streaming uses dual detection methods for [turn detection](https://www.assemblyai.com/docs/streaming/universal-streaming/turn-detection):
...
- Minimum silence: `min_turn_silence` (default 400ms)
...
aggressive_params = {
    ...
    "min_turn_silence": 160,  # Less silence needed
...
conservative_params = {
    ...
    "min_turn_silence": 560,  # More silence before confirming
...
- `min_turn_silence`: Amount of silence required after model is confident turn has ended
...
Universal-Streaming sends [messages in a specific sequence](https://www.assemblyai.com/docs/streaming/universal-streaming/message-sequence) as users speak. Here's a complete example of someone saying "Hi my name is Sonny. I am a voice agent."
...
[Keyterms Prompting](https://www.assemblyai.com/docs/streaming/keyterms-prompting) boosts accuracy for domain-specific vocabulary—product names, people, technical terms:
...
For more details, see the [Keyterms Prompting Guide](https://www.assemblyai.com/docs/streaming/keyterms-prompting).
...
- [Universal-Streaming Documentation](https://www.assemblyai.com/docs/streaming)
- [Getting Started Guide](https://www.assemblyai.com/docs/getting-started/transcribe-streaming-audio)
- [Turn Detection Guide](https://www.assemblyai.com/docs/streaming/universal-streaming/turn-detection)
- [Message Sequence Breakdown](https://www.assemblyai.com/docs/streaming/universal-streaming/message-sequence)
- [Keyterms Prompting Guide](https://www.assemblyai.com/docs/streaming/keyterms-prompting)
