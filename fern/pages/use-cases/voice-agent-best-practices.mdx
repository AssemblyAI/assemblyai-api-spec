...
- [Building a Voice Agent with LiveKit and AssemblyAI (Universal-Streaming)](/docs/voice-agents/livekit-intro-guide)
- [Building a Voice Agent with Pipecat and AssemblyAI](/docs/voice-agents/pipecat-intro-guide)
