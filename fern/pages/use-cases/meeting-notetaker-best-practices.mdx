...
See the [Universal-3 Pro Streaming documentation](https://www.assemblyai.com/docs/streaming/universal-3-pro-streaming) for full details.
...
for utterance in result["results"][0]["utterances"]:
    print(f"{utterance['speaker']}: {utterance['text']}")
```
...
- [Universal-3 Pro Streaming Documentation](https://www.assemblyai.com/docs/streaming)
