...
CONNECTION_PARAMS = {
    ...
    "min_turn_silence": 560,  # Wait longer for natural pauses (voice agents use 160ms)
...
<Note>
  ...
  [tweak these
  settings](https://www.assemblyai.com/docs/streaming/turn-detection) to get the
  best results for your notetaker.
</Note>
...
See our [multichannel streaming guide](https://www.assemblyai.com/docs/streaming/streaming-diarization-and-multichannel#multichannel-streaming-audio) for complete implementation details.
