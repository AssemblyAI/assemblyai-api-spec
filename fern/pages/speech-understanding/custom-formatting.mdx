...
<Code src="snippets/speech-understanding/custom-formatting/python-1.py" />
</Tab>

{/\* <Tab language="python" title="Python SDK">

<Code src="snippets/speech-understanding/custom-formatting/python-2.py" />
</Tab> */}

<Tab language="javascript" title="JavaScript">

<Code src="snippets/speech-understanding/custom-formatting/javascript-1.js" />
</Tab>

{/\* <Tab language="javascript" title="JavaScript SDK">

<Code src="snippets/speech-understanding/custom-formatting/javascript-2.js" />
</Tab> */}
</Tabs>
...
<Code src="snippets/speech-understanding/custom-formatting/python-3.py" />
</Tab>
{/* <Tab language="python" title="Python SDK">

<Code src="snippets/speech-understanding/custom-formatting/python-4.py" />
</Tab> */}
<Tab language="javascript" title="JavaScript">

<Code src="snippets/speech-understanding/custom-formatting/javascript-3.js" />
</Tab>
{/* <Tab language="javascript" title="JavaScript SDK">

<Code src="snippets/speech-understanding/custom-formatting/javascript-4.js" />
</Tab> */}
</Tabs>
...
<Code src="snippets/speech-understanding/custom-formatting/bash-1.sh" />
...
<Code src="snippets/speech-understanding/custom-formatting/bash-2.sh" />| Key |
...
request configuration. | | `speech_understanding.request.custom_formatting` |
object | Yes | Custom formatting configuration. | | `custom_formatting.date` |
string | No | Date format pattern. Common patterns: `mm/dd/yyyy` (US),
`dd/mm/yyyy` (European), `yyyy-mm-dd` (ISO). | |
`custom_formatting.phone_number` | string | No | Phone number format pattern.
Examples: `(xxx)xxx-xxxx`, `xxx-xxx-xxxx`, `xxx.xxx.xxxx`. | |
`custom_formatting.email` | string | No | Email format pattern. Example:
`username@domain.com`. | | `custom_formatting.format_utterances` | boolean | No
| When `true`, applies formatting to speaker utterances in addition to the main
text. Preserves word-level timestamps. Default: `false`. |
