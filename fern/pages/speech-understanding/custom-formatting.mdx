...
<CodeBlocks>
  <Code
    src="./snippets/custom-formatting/quickstart-method1.python.py"
    title="Python"
    language="python"
  />
  {/* <Code
    src="./snippets/custom-formatting/quickstart-method1.python-sdk.py"
    title="Python SDK"
    language="python"
  /> */}
  <Code
    src="./snippets/custom-formatting/quickstart-method1.javascript.js"
    title="JavaScript"
    language="javascript"
  />
  {/* <Code
    src="./snippets/custom-formatting/quickstart-method1.javascript-sdk.js"
...
<CodeBlocks>
  <Code
    src="./snippets/custom-formatting/quickstart-method2.python.py"
    title="Python"
    language="python"
  />
  {/* <Code
    src="./snippets/custom-formatting/quickstart-method2.python-sdk.py"
    title="Python SDK"
    language="python"
  /> */}
  <Code
    src="./snippets/custom-formatting/quickstart-method2.javascript.js"
    title="JavaScript"
    language="javascript"
  />
  {/* <Code
    src="./snippets/custom-formatting/quickstart-method2.javascript-sdk.js"
    title="JavaScript SDK"
    language="javascript"
  /> */}
</CodeBlocks>
...
<Code src="./snippets/custom-formatting/expected-output.txt" language="plain" />
...
<Markdown src="custom-formatting-output-format.mdx" />
...
<Code src="./snippets/custom-formatting/example-config.json" language="json" />
...
<Code
  src="./snippets/custom-formatting/api-request-method1.sh"
  language="bash"
/>
...
<Code
  src="./snippets/custom-formatting/api-request-method2.sh"
  language="bash"
/>
...
<Markdown src="custom-formatting-api-response.mdx" />
