...
This page describes how to perform common operations with the REST API. Each endpoint is documented individually and grouped by the resource it interacts with, such as [Transcripts](/api-reference/transcripts) and [LeMUR](/api-reference/lemur).
...
This page explains the AssemblyAI REST API. If you want to use Streaming Speech-to-Text, see [Streaming API reference](/api-reference/streaming).
</Info>
