...
<Note>
  ...
  `api.eu.assemblyai.com`. See [Cloud Endpoints and Data Residency](/docs/pre-recorded-audio/select-the-region) for more information.
</Note>
...
<Note>
  ...
  `streaming.eu.assemblyai.com`. See [Streaming Endpoints and Data Zones](/docs/streaming-endpoints-and-data-zones) for more information.
</Note>
...
<Note>
  ...
  `llm-gateway.assemblyai.com` with `llm-gateway.eu.assemblyai.com`. See [Cloud Endpoints and Data Residency](/docs/llm-gateway/cloud-endpoints-and-data-residency) for more information.
</Note>
