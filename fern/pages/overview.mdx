...
<Info title="Streaming Speech-to-Text">
  ...
  Speech-to-Text, see [Streaming API reference](/docs/api-reference/streaming).
</Info>
...
- Audio data is corrupted or in an unsupported format. See [FAQ](https://support.assemblyai.com/articles/2616970375-what-audio-and-video-file-types-are-supported-by-your-api) for supported formats.
