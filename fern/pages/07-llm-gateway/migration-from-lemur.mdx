...
<Warning>
  **LeMUR is being deprecated.** We recommend migrating to the [LLM
  Gateway](/docs/llm-gateway) for continued access to language model
  capabilities with more models and better performance.
</Warning>
