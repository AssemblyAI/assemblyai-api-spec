...
| **gpt-oss-120b** | `gpt-oss-120b`      | 10.5s                     | 1352          | OpenAI's most powerful open-weight model                         | Abuse monitoring retains logs for 30 days. If you require ZDR, please use Anthropic or Google models. | AssemblyAI has opted out of model training with all LLM Gateway providers. |
| **gpt-oss-20b**  | `gpt-oss-20b`       | 4.2s                      | 1318          | Medium-sized open-weight model for low latency                   | Abuse monitoring retains logs for 30 days. If you require ZDR, please use Anthropic or Google models. | AssemblyAI has opted out of model training with all LLM Gateway providers. |
