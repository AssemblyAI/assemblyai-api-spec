...
Multi-turn conversations allow you to maintain context by including conversation history in your requests. This enables the model to understand and reference previous messages in the conversation.
