...
<Accordion title="Supported languages" theme="dark" iconColor="white">
  - Global English: `en` - Australian English: `en_au` - British English:
  `en_uk` - US English: `en_us`
</Accordion>
...
<Tip title="Auto Chapters Using LeMUR">
  ...
  Summaries](https://github.com/AssemblyAI/cookbook/blob/master/lemur/input-text-chapters.ipynb)
