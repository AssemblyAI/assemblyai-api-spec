...
Entity Detection is available in multiple languages. See [Supported languages](../01-getting-started/supported-languages.mdx).
</Tip>
...
<CodeBlock>
  <JsonViewer
    ...
    collapsed={1}
    src={(({entities}) => ({entities}))(entityDetection)
}
/>
