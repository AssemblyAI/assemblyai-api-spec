...
while True:
    ...
    if transcription_result['status'] == 'completed':
      for sentiment_result in transcription_result['sentiment_analysis_results']:
        ...
        print(sentiment_result['confidence']) # POSITIVE, NEUTRAL, or NEGATIVE
        print(f"Timestamp: {sentiment_result['start']} - {sentiment_result['end']}")
      break
...
while (true) {
  ...
  if (transcriptionResult.status === 'completed') {
    for sentimentResult of transcriptionResult['sentiment_analysis_results']:
      ...
      console.log(sentimentResult['confidence']) // POSITIVE, NEUTRAL, or NEGATIVE
      console.log(`Timestamp: ${sentimentResult['start']} - {sentimentResult['end']}`)
    break
...
class Program
{
    ...
    {
        var data = new { audio_url = audioUrl, sentiment_analysis = true };
...
while true
  ...
  if transcription_result['status'] == 'completed'
    ...
    transcription_result['sentiment_analysis_results'].each do |sentiment_result|
      ...
      puts sentiment_result['sentiment']
...
```
    ...
    <Tab language="typescript" title="TypeScript" default>
...
```csharp {1}
var data = new { audio_url = audioUrl, sentiment_analysis = true, speaker_labels = true };
```
