...
On top of the core transcription, you can enable other features and models, such as [Speaker Diarization](../02-speech-to-text/speaker-diarization.mdx), by adding additional parameters to the same transcription request.
...
For a list of the supported languages for each model, see [Supported languages](../01-getting-started/supported-languages.mdx).
...
Identify the dominant language spoken in an audio file and use it during the transcription. Enable it to detect any of the [supported languages](../01-getting-started/supported-languages.mdx).
...
To see all supported languages and their codes, see [Supported languages](../01-getting-started/supported-languages.mdx).
