...
- [JavaScript / TypeScript](/docs/getting-started/transcribe-streaming-audio-from-a-microphone/type-script)
...
See this [code example](/docs/build-with-assembly-ai/guides/real-time-streaming-transcription#adding-custom-vocabulary).
</Note>
