...
Speaker Diarization doesn't support multichannel transcription. Enabling both Speaker Diarization and [multichannel](02-speech-to-text/speech-recognition.mdx#multichannel-transcription) will result in an error.
</Warning>
