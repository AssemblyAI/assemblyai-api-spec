...
<Tip title="Looking to improve transcription accuracy?">
  For significantly better results, try our new approach using [LeMUR Custom Vocabulary](/docs/guides/custom-vocab-lemur). This advanced method provides more precise recognition for domain-specific terms and proper nouns without the formatting limitations of traditional word boosting.
</Tip>
