...
```python title="Python SDK" {10-13} maxLines=15
...
```python title="Python" {19-22} maxLines=15
import requests
import time
...
```javascript title="JavaScript SDK" {15-18} maxLines=15
...
```javascript title="JavaScript" {19-22} maxLines=15
import axios from "axios";
...
```python title="Python SDK" {14} maxLines=15
import assemblyai as aai
...
```python title="Python" {24} maxLines=15
import requests
import time
...
```javascript title="JavaScript" {24} maxLines=15
import axios from "axios";
import fs from "fs-extra";
