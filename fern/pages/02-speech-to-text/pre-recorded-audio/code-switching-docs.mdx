...
Supports code switching between: `en`, `es`, `de`, `it`, `pt`, `fr`
...
Supports code switching between: `en`, `es`, `de`

To enable code switching for Universal-2 only, set `language_detection` as `True`, and `code_switching` as `True` as shown in the example below.
