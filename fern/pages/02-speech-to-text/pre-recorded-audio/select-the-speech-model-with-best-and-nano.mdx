---
title: "Select the Speech Models"
---
...
<Note>
For best results, we recommend using [Automatic Language Detection](/docs/pre-recorded-audio/automatic-language-detection) in your request, along with specifying `speech_models`.
</Note>
