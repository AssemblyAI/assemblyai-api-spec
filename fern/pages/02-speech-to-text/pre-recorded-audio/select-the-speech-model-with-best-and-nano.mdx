...
<Tabs>
  ...
  <Tab title="API">
    | Name | API Parameter | Description | | --- | --- | --- | | **Best**
    (default) | `"speech_model":"best"` | Use our most accurate and capable
    models with the best results, recommended for most use cases. | | **Nano** |
    `"speech_model":"nano"` | Use our less accurate, but much lower cost models
    to produce your results. |
  </Tab>
</Tabs>
<br />
