...
| **Slam-1** (beta)       | `aai.SpeechModel.slam_1`    | Use our most customizable model for your transcription (English only).                |
...
| **Slam-1** (beta)       | `'slam-1'`    | Use our most customizable model for your transcription (English only).                |
...
| **Slam-1** (beta)       | `"speech_model":"slam-1"`    | Use our most customizable model for your transcription (English only).                |
...
# if you enabled slam-1 as the SpeechModel above, change line 54 to transcript = aai.Transcriber(config=config).transcribe(audio_file)
