...
| **Universal** (default) | `aai.SpeechModel.universal` | Use our fastest, most robust model with the best results for most languages.          |
| **Nano**                | `aai.SpeechModel.nano`      | Use our lowest cost models with the broadest language support for your transcription. |
...
| **Universal** (default) | `'universal'` | Use our fastest, most robust model with the best results for most languages.          |
| **Nano**                | `'nano'`      | Use our lowest cost models with the broadest language support for your transcription. |
...
| **Universal** (default) | `"speech_model":"universal"` | Use our fastest, most robust model with the best results for most languages.          |
| **Nano**                | `"speech_model":"nano"`      | Use our lowest cost models with the broadest language support for your transcription. |
