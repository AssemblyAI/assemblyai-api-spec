...
<Tabs>
  <Tab language="python-sdk" title="Python SDK">
    ...
    | **Best** (default) | `aai.SpeechModel.best` | Use our fastest, most robust model with the best results for most languages. |
  ...
  <Tab language="typescript-sdk" title="TypeScript SDK">
    ...
    | **Best** (default) | `'best'` | Use our fastest, most robust model with the best results for most languages. |
  ...
  <Tab title="API">
    ...
    | **Best** (default) | `"speech_model":"best"` | Use our fastest, most robust model with the best results for most languages. |
