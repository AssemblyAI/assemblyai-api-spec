...
<Note>
This interactive tool helps you generate a starting prompt based on your selected transcription style. Paste a sample of your transcript and select your preferred style to get a customized prompt recommendation.
</Note>

<PromptGenerator />

<Warning>
**Security note:** Transcript samples are processed locally in your browser and are not sent to any server. For production use, we recommend reviewing and customizing the generated prompt based on your specific domain terminology.
</Warning>
