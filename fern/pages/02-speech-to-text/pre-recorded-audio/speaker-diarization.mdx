...
<Info>
Looking to identify speakers by name across multiple audio files? Check out our [Speaker Identification guide](/docs/guides/identifying-speakers-in-audio-recordings) to learn how to match speaker labels with actual speaker names.
</Info>
