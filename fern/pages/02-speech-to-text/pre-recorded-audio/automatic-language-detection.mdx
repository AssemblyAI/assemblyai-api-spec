...
<Note>If the `language_confidence_threshold` you specify is not met you will receive an error message like "detected language 'bg', confidence 0.2949, is below the requested confidence threshold value of '0.4".</Note>
