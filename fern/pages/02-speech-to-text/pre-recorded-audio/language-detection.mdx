...
```python title="Python SDK" for="python-sdk" {10} maxLines=15
...
```python title="Python" for="python" {20} maxLines=15
import requests
import time
...
```javascript title="JavaScript SDK" for="javascript-sdk" {13} maxLines=15
...
```javascript title="JavaScript" for="javascript" {22} maxLines=15
...
```python title="Python SDK" for="python-sdk" {9} maxLines=15
import assemblyai as aai
...
```python title="Python" for="python" {23} maxLines=15
import requests
import time
...
```javascript title="JavaScript SDK" for="javascript-sdk" {15} maxLines=15
import { AssemblyAI } from "assemblyai";
...
```javascript title="JavaScript" for="javascript" {23} maxLines=15
import axios from "axios";
import fs from "fs-extra";
...
```javascript title="JavaScript SDK" for="javascript-sdk" {16} maxLines=15
import { AssemblyAI } from "assemblyai";
...
```python title="Python SDK" for="python-sdk" {11} maxLines=15
import assemblyai as aai
...
```javascript title="JavaScript SDK" for="javascript-sdk" {14} maxLines=15
import { AssemblyAI } from "assemblyai";
...
```javascript title="JavaScript SDK" {13} maxLines=15
import { AssemblyAI } from "assemblyai";
