...
This page explains how to configure language settings for your transcription requests. You can either set the language manually if you know it in advance, or use automatic language detection to identify the dominant language in your audio.
...
If you're unsure of the spoken language in your audio file, you can enable automatic language detection to identify the dominant language and use it during transcription.
...
- Use the language codes shown in the Supported languages accordion above (e.g., `"en"`, `"es"`, `"fr"`).
