...
async Task<string> GetSrtAsync(string transcriptId, HttpClient httpClient, int charsPerCaption = 32)
{
...
async Task<string> GetVttAsync(string transcriptId, HttpClient httpClient, int charsPerCaption = 32)
{
...
$srt_endpoint = "https://api.assemblyai.com/v2/transcript/" . $transcript_id . "/srt?chars_per_caption=32";
