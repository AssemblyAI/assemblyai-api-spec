...
```python title="Python SDK" highlight={8-9, 16-17}
import assemblyai as aai
...
```python title="Python" highlight={19-20,42-43}
import requests
import time
...
```javascript title="JavaScript SDK" highlight={12-13,19-21}
import { AssemblyAI } from "assemblyai";
...
```javascript title="JavaScript" highlight={19-20,36-38}
import axios from "axios";
import fs from "fs-extra";
