...
$paragraphs_endpoint = "https://api.assemblyai.com/v2/transcript/" . $transcript_id . "/paragraphs";
...
$sentences_endpoint = "https://api.assemblyai.com/v2/transcript/" . $transcript_id . "/sentences";
