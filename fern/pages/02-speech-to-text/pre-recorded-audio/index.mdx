...
<Tip title="Choose Model Class">
  You can use the optional `speech_model` parameter to specify the class of
  models. To learn more, see [Select the speech
  model](/docs/speech-to-text/pre-recorded-audio/supported-languages).
</Tip>
