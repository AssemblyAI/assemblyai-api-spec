...
<Tip title="Choose model class">
  Choose between [_Slam-1_, _Universal_ and
  _Nano_](/docs/speech-to-text/pre-recorded-audio/select-the-speech-model) based
  on the cost and performance tradeoffs best suited for your application.
</Tip>
