...
<Note>
To optimise for latency, we recommend using the unformatted Final Transcript as it's received more quickly than the formatted version. However, this creates a tradeoff as you won't receive punctuation and proper casing. Choose based on whether speed or formatting is more important for your application.
</Note>
...
<Note>
When using the latest Partial Transcript, ignore the subsequent Final Transcript for that segment to avoid sending duplicate information to the voice agent.
</Note>
