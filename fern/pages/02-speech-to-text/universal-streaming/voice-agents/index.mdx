...
<CardGroup cols={2}>
  <Card
    ...
    href="/docs/speech-to-text/universal-streaming/livekit"
  >
  ...
  <Card
    ...
    href="/docs/speech-to-text/universal-streaming/pipecat"
  >
  ...
  <Card
    ...
    href="/docs/speech-to-text/universal-streaming/vapi"
  >
