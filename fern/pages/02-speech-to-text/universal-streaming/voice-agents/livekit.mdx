...
To use AssemblyAI's EU endpoint, set the `base_url` parameter:
...
For more information, see [Select the region](/docs/speech-to-text/universal-streaming/select-the-region).

### Parameters

<ParamField path="base_url" type="str">
  The base URL for the API. Use `wss://streaming.eu.assemblyai.com` for the EU endpoint.
</ParamField>
