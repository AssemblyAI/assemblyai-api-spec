# Keyterm prompting for Universal-Streaming
...
Streaming Keyterm Prompting uses a two-stage approach to improve accuracy for your specified terms.

### Word-level boosting

The streaming model itself is biased during inference to be more accurate at identifying words from your keyterm list. This happens in real-time as words are emitted during the streaming process, providing immediate improvements to recognition accuracy.

### Turn-level boosting

After each turn is completed, an additional metaphone-based boosting pass analyzes the full transcript using your keyterm list. This post-processing step, similar to formatting, provides a second layer of accuracy improvement by examining the complete context of the turn.
...
To maximize the effectiveness of keyterm prompting:
