...
<Warning>
Keyterms boosting is currently a beta feature, but it is available now for all users.

Please note, this feature may change as we work towards the general release of the feature. Please reference this page for the latest information and code examples.
</Warning>
