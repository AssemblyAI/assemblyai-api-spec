...
const CONNECTION_PARAMS = {
  ...
  keyterms: ["Keanu Reeves", "AssemblyAI", "Universal-2"],
};
...
- The `formatted_finals` parameter must be set to `True` for keyterm boosting to be applied.
