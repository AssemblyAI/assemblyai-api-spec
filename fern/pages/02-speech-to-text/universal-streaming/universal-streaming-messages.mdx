...
Lastly we will format the transcript if formatting is enabled. Again this is only recommended for use cases where the end user will be shown the transcript as it adds significant latency for voice agents.
```json
{
  "turn_order": 1,
  "turn_is_formatted": true,
