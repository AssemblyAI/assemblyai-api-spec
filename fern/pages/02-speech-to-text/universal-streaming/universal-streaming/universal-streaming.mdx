...
<Note>
  ...
  If you'd like to enable multilingual streaming (support for English, Spanish, French, German, Italian, and Portuguese), enable [multilingual transcription](/docs/speech-to-text/universal-streaming/multilingual-transcription) instead.
</Note>
...
<ParamField path="keyterms_prompt" type="list of strings" required={false}>
  ...
  <Note>
    [Keyterms prompts](/docs/speech-to-text/universal-streaming/keyterms-prompting) longer than 50 characters are ignored. Requests containing more than 100 keyterms will result in an error.
  </Note>
...
<ParamField path="speech_model" type="string" required={false} default={"universal-streaming-english"}>
  ...
  <Note>
    [Multilingual transcription](/docs/speech-to-text/universal-streaming/multilingual-transcription) is currently in beta and supports English, Spanish, French, German, Italian, and Portuguese.
  </Note>
