...
<Code src="../../snippets/llm-gateway/tool-calling/python-1.py" />
## Handling tool calls

Execute tools and send results back to continue the conversation:

<Code src="../../snippets/llm-gateway/tool-calling/python-2.py" />
## Tool call flow
...
<Code src="../../snippets/llm-gateway/tool-calling/bash.sh" />
#### Request parameters
