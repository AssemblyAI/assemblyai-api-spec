...
<Code src="snippets/llm-gateway/conversations/python-1.py" />
**Note:** You're responsible for managing conversation history. Each request
must include all relevant previous messages - the API doesn't store history
between requests.
...
<Code src="snippets/llm-gateway/conversations/python-2.py" />
</Tab>
<Tab title="JavaScript" language="javascript">

<Code src="snippets/llm-gateway/conversations/javascript.js" />
</Tab>
</Tabs>
...
<Code src="snippets/llm-gateway/conversations/bash.sh" />
#### Request parameters
