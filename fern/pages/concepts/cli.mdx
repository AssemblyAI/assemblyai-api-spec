...
You can also select a speech model using the `--speech_models` flag. This flag requires a list format:

```bash
assemblyai transcribe ./audio.mp3 --speech_models universal-3-pro
```
