...
To do a vibe-eval, set up your voice agent with different STT providers. This can be done quickly with integrations like [LiveKit](https://www.assemblyai.com/docs/voice-agents/livekit-u3-rt-pro) where you can swap out providers.
