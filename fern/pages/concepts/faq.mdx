...
<Warning title="Need more help?">
  Check out our [Knowledge Base](https://support.assemblyai.com/) for additional
...
<Accordion title="Do you have an EU endpoint?">
  Yes - you can use the base URL for EU at `api.eu.assemblyai.com` for the
  `/v2/transcript` path. Check out the [endpoint configuration
  examples](/docs/speech-to-text/pre-recorded-audio/select-the-region) in your
  preferred programming language. Note: The base URL for EU is currently only
  available for Async transcription.
</Accordion>
...
AssemblyAI’s [Universal-3 Pro](/docs/pre-recorded-audio/select-the-speech-model) is our most robust and accurate offering, houses our most powerful models, and has the broadest range of capabilities.

AssemblyAI’s [Universal-2](/docs/pre-recorded-audio/select-the-speech-model) is an offering that gives product and development teams access to Speech AI at a cost-effective price point across 99 languages.
