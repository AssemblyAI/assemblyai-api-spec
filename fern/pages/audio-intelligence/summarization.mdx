...
parameter: summarization (boolean), summary_model (string), summary_type (string)
description: Generate summaries of pre-recorded audio transcripts in different formats. Only available with pre-recorded (async) transcription.
*/}
...
<Tip title="Custom Summaries Using LLM Gateway">
