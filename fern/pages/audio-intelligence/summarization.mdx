...
-------------------------------------------------------------- | |
`summarization` | boolean | Enable Summarization. | | `summary_type` | string |
[Summary type](#summary-types) to use for the transcription. | | `summary_model`
| string | [Summary model](#summary-models) to use for the transcription. |
