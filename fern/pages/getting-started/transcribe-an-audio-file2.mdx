...
<Tip>
**Building a medical scribe or clinical documentation app?** Check out the [Medical Scribe Best Practices](/docs/use-cases/medical-scribe-best-practices) guide for optimized model selection, medical terminology prompting, and HIPAA-compliant configuration.
</Tip>
