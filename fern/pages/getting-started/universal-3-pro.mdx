...
<Note title="Recommended: Test without a prompt first">

We recommend first testing Universal-3 Pro **without** a custom prompt to establish a baseline for your use case. The model delivers strong accuracy out of the box. After reviewing the initial results, you can then craft a prompt to fine-tune the output and compare the two to ensure your prompt is actually improving accuracy for your specific audio.
