...
Universal-3 Pro is our most powerful Voice AI model yet, designed to capture the "hard stuff" that traditional ASR models struggle with. The model out of the box outperforms all ASR models on the market on accuracy, especially as it pertains to entities and rare words. It also excels at recognizing regional dialects and local speech variants — from Canadian French and Brazilian Portuguese to Spanglish and Bavarian German — so your transcriptions match how people actually speak. With prompting, you can get an entirely customized transcription output that rivals near-human-level transcription.
