...
<Note>
  See [Streaming endpoints and data
  zones](/docs/streaming-endpoints-and-data-zones) for more information on
  endpoints for Streaming STT.
</Note>
...
<Tip title="Message sequence and turn events">
  ...
  Breakdown](/docs/streaming/universal-streaming/message-sequence) page. This
