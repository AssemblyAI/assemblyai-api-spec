...
<Code src="snippets/integrations/zoom-rtms/javascript.js" />
See [AssemblyAI's API
documentation](https://www.assemblyai.com/docs/api-reference/transcripts/submit)
