...
<Code src="../../snippets/integrations/genesys-async/bash-1.sh" />
<Note>
...
<Code src="../../snippets/integrations/genesys-async/javascript-1.js" />
</Step>
<Step>
...
<Code src="../../snippets/integrations/genesys-async/javascript-2.js" />
<Tip>
...
<Code src="../../snippets/integrations/genesys-async/bash-2.sh" />
</Step>
<Step>

Once the call has ended, you should see the following server logs:

<Code src="../../snippets/integrations/genesys-async/bash-3.sh" />
</Step>
<Step>
