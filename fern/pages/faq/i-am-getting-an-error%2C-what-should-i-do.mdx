...
2. Check our [Common Errors Guide](https://github.com/AssemblyAI/cookbook/blob/master/core-transcription/common_errors_and_solutions.md) for solutions to frequently encountered errors and how to resolve them.
