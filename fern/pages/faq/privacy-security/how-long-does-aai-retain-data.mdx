...
|----------------|------------------------|--------------|---------------|-------------------------------------|
| **Customer-Uploaded Audio Files** | Deleted when the TTL time has elapsed. | Deletion process begins at 24 hours and is at most 48 hours. | Deletion process begins at 24 hours and is at most 48 hours. | Deleted when customer initiates deletion request. |
