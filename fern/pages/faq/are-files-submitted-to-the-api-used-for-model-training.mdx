...
a) offer an opt-out, or
b) would agree to prohibit by contract.
...
> **Note**: opting out only applies to future training. We cannot untrain or remove data from models retroactively.