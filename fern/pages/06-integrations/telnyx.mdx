...
- [Telnyx LiveKit SIP Setup](https://developers.telnyx.com/docs/voice/sip-trunking/livekit-configuration-guide) - Telnyx and LiveKit integration documentation

## Pipecat Telephony Integration
...
- [Telnyx Pipecat Integration Guide](https://docs.pipecat.ai/guides/telephony/telnyx-websockets)
