...
Upon call completion, the server will process this audio into a wav file and send it to AssemblyAI's Speech-to-text API for [pre-recorded audio](https://www.assemblyai.com/docs/speech-to-text/pre-recorded-audio) transcription.
