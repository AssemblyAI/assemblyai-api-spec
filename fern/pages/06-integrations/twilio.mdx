...
Combine transcription with our [audio intelligence models](/docs/audio-intelligence/summarization) and [LeMUR LLM framework](/docs/lemur/summarize-your-audio-data) to analyze the calls and messages.
