...
The dataset used for this benchamrk is the [FLEURS dataset](https://huggingface.co/datasets/google/fleurs), a commonly used multilingual audio dataset.
...
There are many models on leaderboards that are purely for transcription and require self-hosting and/or additional features like speaker diarization, automatic language detection, etc. to perform like AssemblyAI in production.
...
AssemblyAI has a benchmarking tool we can use to help you run a custom benchmark against your real audio files. We're happy to help. Feel free to [contact us](https://www.assemblyai.com/contact/support) for more information.

You can also run your own following the [Hugging Face framework](https://github.com/huggingface/open_asr_leaderboard) which has a Github repo with full instructions for running your own.
