...
## AssemblyAI Streaming Speech-to-text Benchmarks

<Note>
    Due to benchmark gaming / overfitting, many models intentionally do things like emit hallucinated tokens to drive faster TTFT/TTFB and appear "fastest" on leaderboards. This is why we highly recommend running your own evaluations on your own datasets to get the best model for your use case.
</Note>
