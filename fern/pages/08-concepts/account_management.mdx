...
Paid accounts automatically scale their concurrency limit based on usage.
...
If this occurs, wait 10 seconds before retrying the connection. Our system will automatically adjust your limit to match your needs.
