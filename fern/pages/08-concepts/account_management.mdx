...
Usage limits for streaming speech-to-text are distinct from asynchronous speech-to-text usage limits. Your streaming concurrency dictates the number of new streaming sessions that can be opened per minute.
