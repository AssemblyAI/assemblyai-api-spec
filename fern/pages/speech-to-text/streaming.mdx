...
<Error>
  ...
  Streaming model, which you can learn more about [here](/docs/streaming)
</Error>
...
<Note>
  ...
  example](/docs/getting-started/transcribe-streaming-audio#adding-custom-vocabulary).
</Note>
...
- Use partial transcripts instead of waiting for final transcripts. Partial transcripts provide faster feedback but may be less accurate. See our [Cookbook example](/docs/streaming/universal-3-pro/turn-detection-and-partials) for more information.
