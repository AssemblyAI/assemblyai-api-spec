...
<Code src="snippets/speech-to-text/pipecat-intro-guide/python-1.py" />
Below is a code snippet that uses our STT within Pipecat's [basic voice agent
example](https://github.com/pipecat-ai/pipecat/blob/main/examples/foundational/07-interruptible.py)
structure. This example is great because it comes with a great UI.

Please create a file called `voice_agent.py` and copy and paste this code:

<Code src="snippets/speech-to-text/pipecat-intro-guide/python-2.py" />
...
<Code src="snippets/speech-to-text/pipecat-intro-guide/python-3.py" />
**Parameter tuning:**
...
<Code src="snippets/speech-to-text/pipecat-intro-guide/python-4.py" />
This replaces the existing system message in the code. The current example uses:

<Code src="snippets/speech-to-text/pipecat-intro-guide/python-5.py" />
For customizing Rime TTS voices, see the [Pipecat Rime TTS
documentation](https://docs.pipecat.ai/server/services/tts/rime).
