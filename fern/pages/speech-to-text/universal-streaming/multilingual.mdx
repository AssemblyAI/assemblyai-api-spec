...
<Note title="Need more than 6 languages?">
  If you need support beyond the 6 languages listed here, consider using the **Whisper Streaming** model (`speech_model: "whisper-rt"`), which supports **99 languages** with automatic language detection. See the [Whisper Streaming](#whisper-streaming) section below for details.
</Note>
