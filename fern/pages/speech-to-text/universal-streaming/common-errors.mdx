...
| ------ | ------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `3008` | Session Expired: Maximum session duration exceeded                             | Session exceeded 3 hour limit (or max session duration set by [temporary token](/docs/speech-to-text/universal-streaming#authenticate-with-a-temporary-token)).                                                                                                            |
...
| `3006` | Invalid Message Type: `<message>`                                              | Unsupported [message type](/docs/speech-to-text/universal-streaming#message-types).                                                                                                                                                                                        |
