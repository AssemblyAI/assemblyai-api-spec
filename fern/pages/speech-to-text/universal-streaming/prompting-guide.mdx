...
{
  "type": "UpdateConfiguration",
  "prompt": "Transcribe verbatim. Rules: Always include punctuation in output. Use period/question mark ONLY for complete sentences. Use comma for mid-sentence pauses. Use no punctuation for incomplete trailing speech. Filler words (um, uh, so, like) indicate speaker will continue. Additional: This is a cardiology appointment."
}
```
