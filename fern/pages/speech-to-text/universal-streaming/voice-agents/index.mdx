...
recommendation: For new voice agent projects, we recommend using Universal-3 Pro Streaming (speech_model: "u3-rt-pro") instead, which offers higher accuracy, native code switching, and sub-300ms latency.
description: Voice agent integration guide for Universal Streaming models. Consider upgrading to Universal-3 Pro Streaming for best results.
_/}
