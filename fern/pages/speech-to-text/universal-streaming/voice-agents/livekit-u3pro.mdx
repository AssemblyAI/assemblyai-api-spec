...
<Warning>
Failing to set these parameters correctly is the most common cause of poor performance with U3-Pro on LiveKit.
</Warning>
...
<Note>
Noise cancellation is optional and only recommended in very noisy environments. It can introduce audio artifacts that negatively impact transcription quality. If your telephony provider or SIP trunk already applies noise cancellation, adding a second layer can make things worse.
</Note>
