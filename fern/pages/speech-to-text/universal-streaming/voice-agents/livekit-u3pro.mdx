...
- **Set `min_end_of_turn_silence_when_confident` to `100`.** This minimizes end-of-turn latency and prevents "are you there?" moments. The default of `400` adds unnecessary delay with U3-Pro.
