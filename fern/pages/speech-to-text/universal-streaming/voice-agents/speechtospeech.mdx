...
<Tabs>
<Tab title="cURL">
<Code src="../../../../snippets/speech-to-text/universal-streaming/voice-agents/speechtospeech/curl.sh" />
</Tab>
<Tab title="Python">
<Code src="../../../../snippets/speech-to-text/universal-streaming/voice-agents/speechtospeech/python.py" />
