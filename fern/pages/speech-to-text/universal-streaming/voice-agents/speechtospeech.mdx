...
recommendation: For new voice agent projects, we recommend using Universal-3 Pro Streaming (speech_model: "u3-rt-pro") for best accuracy and latency.
description: Speech-to-Speech voice agent framework (early stage). Consider Universal-3 Pro Streaming for production use.
_/}
