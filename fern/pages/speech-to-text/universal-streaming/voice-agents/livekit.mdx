...
<Note>
  This guide assumes prior knowledge of LiveKit. If you haven't used LiveKit
  before and are unfamiliar with LiveKit, please check out our [Building a Voice
  Agent with LiveKit and AssemblyAI
  guide](https://www.assemblyai.com/docs/speech-to-text/livekit-intro-guide).
</Note>
...
<Tip title="Looking for a full code example?">
  See our Livekit tutorial guide
  [here](/docs/speech-to-text/livekit-intro-guide).
</Tip>
...
For more information, see our [Universal-Streaming end-of-turn detection guide](https://www.assemblyai.com/docs/streaming#end-of-turn-detection) and [message-by-message breakdown](https://www.assemblyai.com/docs/streaming/message-sequence).
...
<ParamField path="end_of_turn_confidence_threshold" type="float" default="0.4">
  ...
  reached. In our API the default is 0.4, but the default in LiveKit is set to
  0.65.
</ParamField>

<ParamField path="min_turn_silence" type="int" default="400">
