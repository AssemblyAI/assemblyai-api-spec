...
<Code src="snippets/speech-to-text/universal-streaming/voice-agents/livekit/python-1.py" />
## Configuration
...
<Code src="snippets/speech-to-text/universal-streaming/voice-agents/livekit/python-2.py" />
**Parameter tuning:**
