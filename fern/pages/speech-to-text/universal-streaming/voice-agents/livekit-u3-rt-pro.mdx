...
<Tip>
  Support for **Universal-3 Pro** requires `livekit-agents` version [**1.4.4**](https://pypi.org/project/livekit-agents/1.4.4/) or later.
</Tip>
...
<Warning>
  Make sure to install the latest version of `livekit-agents` from PyPI (support for **Universal-3 Pro** was added in [livekit-agents@1.4.4](https://github.com/livekit/agents/releases/tag/livekit-agents%401.4.4)).
