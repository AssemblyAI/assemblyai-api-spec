...
<Code src="../../../../snippets/speech-to-text/universal-streaming/voice-agents/pipecat/python-1.py" />
## Configuration
...
<Code src="../../../../snippets/speech-to-text/universal-streaming/voice-agents/pipecat/python-2.py" />
**Parameter tuning:**
