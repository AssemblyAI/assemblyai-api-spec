...
Universal-3 Pro Streaming handles message sequences differently from [Universal Streaming](/docs/message-sequence). Instead of emitting word-by-word partial transcripts as audio is processed, Universal-3 Pro Streaming produces transcripts only during silence periods. Key differences include:
...
For the Universal Streaming message sequence, see [Message Sequence](/docs/message-sequence).
