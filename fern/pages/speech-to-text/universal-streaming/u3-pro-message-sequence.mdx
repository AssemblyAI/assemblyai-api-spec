...
<Note>
  **Key takeaway:** For Universal-3 Pro, you can always use `transcript` — the
  `utterance` field provides no additional information beyond what `transcript`
  already contains. This field exists for API consistency with
