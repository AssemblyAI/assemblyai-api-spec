...
<Note>
  **Key takeaway:** For Universal-3 Pro Streaming, you can always use `transcript` — the
...
Universal-3 Pro Streaming handles message sequences differently from [Universal Streaming](/docs/streaming/message-sequence). Instead of emitting word-by-word partial transcripts as audio is processed, Universal-3 Pro Streaming produces transcripts only during silence periods. Key differences include:
