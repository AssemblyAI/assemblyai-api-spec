...
<Note>
  ...
  Sequence Breakdown](/docs/message-sequence) guide.
</Note>
...
<AccordionGroup>
  ...
  <Accordion title="Turn">
    ...
    For the full breakdown of the message sequence for a turn, see the [Message sequence breakdown guide](/docs/message-sequence).
