...
<Code src="snippets/speech-to-text/universal-streaming/temporary-token/python-sdk-1.py" />
</Tab>
...
<Code src="snippets/speech-to-text/universal-streaming/temporary-token/python-1.py" />
</Tab>
...
<Code src="snippets/speech-to-text/universal-streaming/temporary-token/python-sdk-2.py" />
</Tab>
<Tab language="python" title="Python">

To use it, specify the `token` parameter as a query parameter in the WebSocket URL.

<Code src="snippets/speech-to-text/universal-streaming/temporary-token/python-2.py" />
</Tab>
<Tab language="javascript-sdk" title="JavaScript SDK">
