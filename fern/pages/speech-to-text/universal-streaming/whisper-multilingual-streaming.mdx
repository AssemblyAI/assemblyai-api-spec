...
<Code src="../../../snippets/speech-to-text/universal-streaming/whisper-multilingual-streaming/python.py" highlight={[26]} />
</Tab>

<Tab language="python-sdk" title="Python SDK">

<Code src="../../../snippets/speech-to-text/universal-streaming/whisper-multilingual-streaming/python-sdk.py" highlight={[27]} />
</Tab>
...
<Code src="../../../snippets/speech-to-text/universal-streaming/whisper-multilingual-streaming/javascript-sdk.js" highlight={[11]} />
</Tab>
