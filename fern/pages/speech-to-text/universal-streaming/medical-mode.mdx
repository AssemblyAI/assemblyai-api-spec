...
Because Medical Mode is a post-processing step, it works across all streaming speech models. Set `speech_model` to your preferred model and add `domain: "medical-v1"` to your connection parameters to enable it.
