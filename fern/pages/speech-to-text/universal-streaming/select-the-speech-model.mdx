...
| ------------------------------------- | ---------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ |
| **Universal-Streaming** (default)     | `"speech_model": "universal-streaming"`              | Our low-latency streaming model optimized for real-time English transcription.                                           |
...
def main():
    ...
    client.connect(
        StreamingParameters(
            ...
            format_turns=True,
            speech_model="u3-pro",
            # To use Universal-Streaming English instead, comment out the line above
...
CONNECTION_PARAMS = {
    ...
    "format_turns": True,
    "speech_model": "u3-pro",
    # To use Universal-Streaming English instead, remove the speech_model parameter
    # To use Universal-Streaming Multilingual, use:
    # "speech_model": "universal-streaming-multilingual",
}
...
const run = async () => {
  ...
  const transcriber = client.streaming.transcriber({
    ...
    formatTurns: true,
    speechModel: "u3-pro",
    // To use Universal-Streaming English instead, remove the speechModel parameter
    // To use Universal-Streaming Multilingual, use:
