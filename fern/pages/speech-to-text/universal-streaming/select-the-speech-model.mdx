...
| **Universal-Streaming English** (default) | `"speech_model": "universal-streaming-english"`      | An English transcription model offering a good balance of speed and cost-effectiveness.                                                                 | Cost-effective English real-time transcription, English-only real-time apps                                                          |
