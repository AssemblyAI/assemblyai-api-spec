...
| Feature                        | Universal-Streaming English | Native Code Switching |
| ------------------------------ | --------------------------- | -------------------------------- |
| **Latency**                    | Fastest                     | Fast                             |
| **Partial transcripts**        | Yes                         | Yes                              |
| **Multilingual**               | No                          | Per Turn                         |
| **Entity accuracy**            | Okay                        | Okay                             |
| **Disfluencies & filler words** | No                          | No                               |
| **Customization**              | [Keyterms prompting](/docs/universal-streaming/keyterms-prompting) (known context) | [Keyterms prompting](/docs/universal-streaming/keyterms-prompting) (known context) |
