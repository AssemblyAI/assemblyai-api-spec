...
For detailed setup and configuration of Whisper streaming, see the [Multilingual streaming](/docs/streaming/multilingual-transcription#whisper-streaming) page.
