...
| **Universal-3-Pro** (testing)             | `"speech_model": "u3-rt-pro"`                        | Our highest accuracy model with **native multilingual code switching** — seamlessly handles speakers who switch between languages mid-sentence — plus entity accuracy, performance across varying audio, and prompting support. |

## Choosing a model

| Feature                         | Universal-Streaming English                                              | Native Code Switching                                                    | Universal-3-Pro Streaming                                                                                                                                        |
| ------------------------------- | ------------------------------------------------------------------------ | ------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| **Customization**               | [Keyterms prompting](/docs/streaming/keyterms-prompting) (known context) | [Keyterms prompting](/docs/streaming/keyterms-prompting) (known context) | [Keyterms prompting](/docs/streaming/keyterms-prompting) (known context) + [Native prompting](/docs/getting-started/universal-3-pro#prompting) (unknown context) |
...
const run = async () => {
  ...
  const transcriber = client.streaming.transcriber({
    sampleRate: 16_000,
    speechModel: "u3-rt-pro", // or "universal-streaming-english", "universal-streaming-multilingual"
    minTurnSilence: 100,
    maxTurnSilence: 1200,
