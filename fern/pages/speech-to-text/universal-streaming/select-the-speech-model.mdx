...
<Warning title="Universal-3-Pro: Testing only">
  The Universal-3-Pro streaming model is currently available for testing
  purposes only. It is not yet recommended for production workloads as we are
  currently scaling out our infrastructure.
</Warning>
...
| **Universal-3-Pro** (testing)             | `"speech_model": "u3-rt-pro"`                        | Our highest accuracy model with native multilingual code switching, entity accuracy, performance across varying audio, and prompting support.    |
| **Whisper Streaming**                     | `"speech_model": "whisper-streaming"`                | Transcribe audio streams in 99 languages using the [WhisperLiveKit](https://pypi.org/project/whisperlivekit/) model with automatic language detection. |

## Choosing a model

| Feature                         | Universal-Streaming English                                                        | Native Code Switching                                                              | Universal-3-Pro Streaming                                                                                                                                                  | Whisper Streaming                                                  |
| ------------------------------- | ---------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------ |
| **Latency**                     | Fastest                                                                            | Fast                                                                               | Fast                                                                                                                                                                       | Moderate                                                           |
| **Partial transcripts**         | Yes                                                                                | Yes                                                                                | Yes                                                                                                                                                                        | Yes                                                                |
| **Multilingual**                | No                                                                                 | Per Turn                                                                           | Native Code Switching                                                                                                                                                      | 99 languages (auto-detected)                                       |
| **Entity accuracy**             | Okay                                                                               | Okay                                                                               | Best                                                                                                                                                                       | Okay                                                               |
| **Disfluencies & filler words** | No                                                                                 | No                                                                                 | Yes                                                                                                                                                                        | No                                                                 |
| **Language detection**          | No                                                                                 | No                                                                                 | No                                                                                                                                                                         | Yes (with confidence scores)                                       |
| **Non-speech tags**             | No                                                                                 | No                                                                                 | No                                                                                                                                                                         | Yes (`[Silence]`, `[Music]`, etc.)                                 |
| **Customization**               | [Keyterms prompting](/docs/streaming/keyterms-prompting) (known context) | [Keyterms prompting](/docs/streaming/keyterms-prompting) (known context) | [Keyterms prompting](/docs/streaming/keyterms-prompting) (known context) + [Native prompting](/docs/getting-started/universal-3-pro#prompting) (unknown context) | No                                                                 |

For detailed setup and configuration of Universal-3-Pro streaming, see the [Universal-3 Pro](/docs/streaming/universal-3-pro) page. For prompting guidance, see the [Prompting guide](/docs/streaming/prompting).

## Whisper Streaming

Whisper streaming allows you to transcribe audio streams in 99 languages using the [WhisperLiveKit](https://pypi.org/project/whisperlivekit/) model. To use Whisper streaming, set `speech_model` to `"whisper-streaming"` in the WebSocket URL.
...
<Accordion title="Supported languages (99)">
...
def main():
    ...
    client.connect(
        StreamingParameters(
            sample_rate=16000,
            speech_model="u3-rt-pro",  # or "universal-streaming-english", "universal-streaming-multilingual", "whisper-streaming"
...
const run = async () => {
  ...
  const transcriber = client.streaming.transcriber({
    sampleRate: 16_000,
    speechModel: "u3-rt-pro", // or "universal-streaming-english", "universal-streaming-multilingual", "whisper-streaming"
