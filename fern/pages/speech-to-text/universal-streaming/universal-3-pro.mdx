...
We strongly recommend testing with no `prompt` first. When you omit the `prompt` parameter, Universal-3-Pro automatically applies a built-in [default prompt](#default-prompt) optimized for turn detection and streaming accuracy — delivering 88% turn detection accuracy out of the box. If you need to customize, build off of the [default prompt](#default-prompt) rather than starting from scratch.
