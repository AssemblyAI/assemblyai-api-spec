...
<Tip title="Already using AssemblyAI streaming?">
  ...
  other code changes are required — just update the model, set your turn
  silence parameters, and start streaming.
</Tip>
...
Prompting for streaming is currently in beta. Prompting behavior may change as we continue to refine the model. We recommend testing thoroughly and iterating on your prompts as the feature evolves.
</Warning>
...
<Note title="Prompt and Keyterms Prompt">
  ...
  prompt](#default-prompt) automatically. See [How keyterms prompting works behind the scenes](#how-keyterms-prompting-works-behind-the-scenes) below.
</Note>
