...
You can override the default prompt by providing your own `prompt` value. See the [Prompting guide](/docs/universal-streaming/prompting) for details and examples.
