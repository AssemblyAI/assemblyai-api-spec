...
<Code src="snippets/speech-to-text/pre-recorded-audio/improving-transcript-accuracy/python.py" highlight={[12]} />
</Tab>
<Tab language="javascript" title="JavaScript">

<Code src="snippets/speech-to-text/pre-recorded-audio/improving-transcript-accuracy/javascript.js" highlight={[13]} />
</Tab>
</Tabs>
