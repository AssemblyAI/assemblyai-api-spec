...
In addition to the [default prompt](#best-all-around-default), we recommend testing with the [Best all around (default)](#best-all-around-default) and the [Handling unclear audio with [masked]](#handling-unclear-audio-with-masked) prompt to find the best fit for your evaluation and use case.
