...
api-endpoint: POST https://api.assemblyai.com/v2/transcript (US), POST https://api.eu.assemblyai.com/v2/transcript (EU)
description: Available cloud regions for pre-recorded audio transcription. EU region available for async transcription only.
_/}
