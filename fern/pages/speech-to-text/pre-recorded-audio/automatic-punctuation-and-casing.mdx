...
<Note title="Supported Languages, Regions, and Models">
  Automatic Punctuation and Casing is supported for all languages, regions, and
  models.
</Note>
...
<Info title="Disabling punctuation and casing">
  Disabling punctuation and casing is most effective when used for English,
  Spanish, and German. Exact results of disabling these default features can
  vary by language.
</Info>
