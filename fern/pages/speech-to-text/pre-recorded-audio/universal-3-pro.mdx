...
If you need to customize behavior, we recommend building off of the [default prompt](#default-prompt) rather than starting from scratch. If you'd like to build your own prompt, please read the [Prompting Guide (Async)](/docs/pre-recorded-audio/prompting) for detailed guidance on crafting effective prompts.
