...
If you need to customize behavior, we recommend building off of the [default prompt](#default-prompt) rather than starting from scratch. See the [Prompting guide](/docs/pre-recorded-audio/prompting) for detailed guidance.
