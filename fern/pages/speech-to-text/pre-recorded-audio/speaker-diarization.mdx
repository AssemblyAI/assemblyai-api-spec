...
<Note title="Supported Languages, Regions, and Models">
  Speaker diarization transcription is supported for all regions and models. For supported languages, see our [Supported Languages](/docs/pre-recorded-audio/supported-languages) page.
</Note>
