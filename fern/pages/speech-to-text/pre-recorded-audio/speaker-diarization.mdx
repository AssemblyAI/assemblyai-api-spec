...
<Info>
By default, the upper limit on the number of speakers for Speaker Diarization is 10. If you expect more than 10 speakers, you can use `speaker_options` to [set a range of possible speakers](/docs/pre-recorded-audio/speaker-diarization#set-a-range-of-possible-speakers).
</Info>
...
>
  ...
  the audio file. See the [best practices](#best-practices-for-accurate-diarization)
  section above for tips on improving accuracy.
</Accordion>
