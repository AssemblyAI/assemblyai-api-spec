...
<Tip title="Looking to improve transcription accuracy?">
  ...
  Vocabulary](/docs/pre-recorded-audio/keyterms-prompting). This advanced method
  provides more precise recognition for domain-specific terms and proper nouns
  without the formatting limitations of traditional word boosting.
</Tip>
