...
<Tip title="Recommended: Universal-3 Pro Streaming">
  For best results with voice agents, we recommend using Universal-3 Pro
  Streaming. Check out our [Universal-3 Pro Streaming on
  LiveKit](/docs/voice-agents/livekit-u3-rt-pro) guide!
</Tip>
