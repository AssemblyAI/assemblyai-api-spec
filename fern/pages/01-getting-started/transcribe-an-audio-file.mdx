...
upload_url = response.json()["upload_url"]
  ...
  <Tab language="golang" title="Go SDK">
  ...
  <Tab language="java" title="Java SDK">
  ...
  <Tab language="csharp" title="C# SDK">
...
<Tab language="ruby" title="Ruby SDK">
...
To generate the transcript, pass the audio URL to `transcriber.transcribe()`. This may take a minute while we're processing the audio.
...
To generate the transcript, pass the audio URL to `client.Transcripts.TranscribeAsync()`. This may take a minute while we're processing the audio.
