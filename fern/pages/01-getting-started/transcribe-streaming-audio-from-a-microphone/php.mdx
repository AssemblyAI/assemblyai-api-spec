---
title: 'Transcribe streaming audio from a microphone in PHP'
subtitle: 'Learn how to transcribe streaming audio in PHP.'
hide-nav-links: true
description: 'Learn how to transcribe streaming audio in PHP.'
---
...
By the end of this tutorial, you'll be able to transcribe audio from your microphone in PHP.
...
- [PHP](https://www.php.net/manual/en/install.php) 7.4 or above.
