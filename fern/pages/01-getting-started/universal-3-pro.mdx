...
- Increased processing times - processing long audio files takes longer than our existing models at least during the week of 1/19. Processing times for the official release will be much faster.
...
- There are edge cases where timestamp are not accurate for a small number of words in your transcript.
