...
Universal-3-Pro is our most powerful transcription model yet, designed to capture the "hard stuff" that traditional ASR models struggle with, namely:
...
Universal-3-Pro supports English, Spanish, Portuguese, French, German, and Italian. To access [all 99 languages](https://assemblyai-preview-c0e96572-0702-4841-be8f-d5e6607ed4ef.docs.buildwithfern.com/docs/pre-recorded-audio/supported-languages), use `"speech_models": ["universal-3-pro", "universal"]` as shown in the code example.
...
Here is an example of a prompt for verbatim transcription that includes filler words, repetitions, restarts, stutters, and informal speech:
