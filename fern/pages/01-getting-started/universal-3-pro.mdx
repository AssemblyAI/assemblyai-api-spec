...
Universal-3-Pro has built-in code switching capabilities across English, Spanish, Portuguese, French, German, and Italian. Set `"language_detection": true`, as shown in the code example in the Overview section, to be routed to the appropriate ASR model.
