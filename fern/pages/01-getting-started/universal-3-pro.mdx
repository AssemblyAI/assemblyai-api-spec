...
- **Universal 3 Pro Multilingual**: Supports English, Spanish, German, French, Portuguese, and Italian. Multilingual Universal 3 Pro is particularly useful for code-switching scenarios.

<Warning>

While Universal 3 Pro Multilingual supports English, it is not as performant as Universal 3 Pro on English-only audio.
