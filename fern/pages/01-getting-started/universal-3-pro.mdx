...
The `temperature` parameter accepts values from 0.0 to 2.0, with a default value of 0.0.

**When to adjust temperature:**

- Use values closer to **0.0** for analytical tasks, multiple choice scenarios, or when you need more deterministic and consistent transcription outputs
- Use values closer to **2.0** for creative and generative tasks where more variation in output is acceptable

<Note>
Even with a temperature of 0.0, results will not be fully deterministic due to the nature of the model's processing.
</Note>

### Example usage

Here's an example showing how to use the temperature parameter in your transcription request:
