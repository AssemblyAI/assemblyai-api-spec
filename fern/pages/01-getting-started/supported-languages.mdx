...
## Specify the speech models

You can use the optional `speech_models` parameter to specify the models to use for your request. To learn more, see [Select the speech model](/docs/speech-to-text/pre-recorded-audio/select-the-speech-model-with-best-and-nano).
