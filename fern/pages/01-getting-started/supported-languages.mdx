...
AssemblyAI offers three different levels of speech-to-text models: **Slam-1**, **Universal**, and **Nano**. Check out the [Models](/docs/getting-started/models) page of our documentation to learn more about our different models and how to choose the best one for your use case.
