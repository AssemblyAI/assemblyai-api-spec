...
**Select the speech model** (optional): The default speech model is [Universal](/docs/getting-started/models#universal). You only need to specify a speech model if you would like to use our [Slam-1](/docs/getting-started/models#slam-1) model. To use Slam-1, create a TranscriptionConfig object and set the `speech_model` to `aai.SpeechModel.slam_1`.
...
**Select the speech model** (optional): The default speech model is [Universal](/docs/getting-started/models#universal). You only need to specify a speech model if you would like to use our [Slam-1](/docs/getting-started/models#slam-1) model. To use Slam-1, add the `speech_model` parameter to `data` with a value of "slam-1".
...
**Select the speech model** (optional): The default speech model is [Universal](/docs/getting-started/models#universal). You only need to specify a speech model if you would like to use our [Slam-1](/docs/getting-started/models#slam-1) model. To use Slam-1, create a params object and set the `speech_model` to `slam-1`.
