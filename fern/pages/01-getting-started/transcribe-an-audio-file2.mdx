...
<Info title="Need EU data residency?">
Use our EU endpoint by changing `baseUrl` to `"https://api.eu.assemblyai.com"`.
</Info>
...
- Uses [our Automatic Language Detection model](/docs/pre-recorded-audio/automatic-language-detection) to detect the dominant language in the spoken audio.
