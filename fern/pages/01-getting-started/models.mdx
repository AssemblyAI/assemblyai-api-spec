...
<CardGroup cols={2}>
  ...
  >
    ...
    State-of-the-art accuracy across 6 languages <br />
    Natural language prompting <br />
    Keyterms prompting up to 1,000 words <br />
    Built-in code switching <br />
    Multichannel support, speaker diarization, language detection, & more
    </span>
  </Card>
  <Card
    title="Universal-2"
  ...
  >
    <span style={{fontSize: '14px'}}>
    High accuracy, low latency across 99 languages <br />
    Keyterms prompting up to 200 words <br />
    Multichannel, speaker diarization, language detection, code switching, & more
    </span>
  </Card>
  <Card
