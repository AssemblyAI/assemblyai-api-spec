...
<Accordion title="Good accuracy (>10% to ≤25% WER)">
  ...
  Korean, Macedonian, Malay, Norwegian Bokmål, Romanian, Slovak, Swedish, Tagalog, Thai,
  Urdu, Vietnamese
</Accordion>
...
<Warning>The rates shown above are offered subject to participation in our model improvement program to help us continue to provide best-in-class speech-to-text. Rates may be different for accounts that opt out of this program.</Warning>
