...
<CardGroup cols={2}>
  ...
  >
    Highest accuracy for English with fine-tuning support and customization via
    prompting
  </Card>
  <Card
    title="Universal"
    ...
    href="/docs/speech-to-text/pre-recorded-audio/select-the-speech-model"
  >
    Best for out-of-the-box transcription with multi-lingual support, excellent accuracy, and low
    latency
  </Card>
  <Card
    title="Nano"
  ...
  <Card title="Streaming" icon="bolt" href="/docs/speech-to-text/streaming">
    Optimized for voice agents and real-time applications with immutable transcripts in ~300ms
  </Card>
</CardGroup>
...
- For real-time transcription, check out our [streaming documentation](/docs/getting-started/transcribe-streaming-audio-from-a-microphone/python)
