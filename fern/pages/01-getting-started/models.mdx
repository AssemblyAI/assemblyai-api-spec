...
<CardGroup cols={2}>
  ...
  >
    - State-of-the-art accuracy across 6 languages
    - Prompting for context, verbatim, audio tagging and speaker diarization
    - Keyterms prompting up to 1,000 words
    - Built-in code switching
    - Multichannel support, language detection, speaker diarization & more
  </Card>
  <Card
    title="Universal-2"
    icon="globe"
    href="/docs/speech-to-text/pre-recorded-audio/select-the-speech-model"
  >
    - High accuracy, low latency across 99 languages
    - Keyterms prompting up to 200 words
    - Multichannel, language detection, code switching, diarization & more
  </Card>
  <Card
  ...
  >
    - Real-time transcription in 6 languages
    - 300ms (P50) latency on immutable finals
    - Keyterms prompting up to 100 words
    - Configurable silence thresholds and confidence parameters
  </Card>
</CardGroup>
