...
- Basic understanding of how to [Transcribe an audio file](../01-getting-started/transcribe-an-audio-file.mdx).
...
For more information about transcribing audio, see [Transcribe an audio file](../01-getting-started/transcribe-an-audio-file.mdx).
...
For more techniques on how to build prompts, see [Improving your prompt](../04-lemur/improving-your-prompt.mdx).
...
Write a prompt with instructions on how LeMUR should generate the text output. The final model defines the LLM to use to process the task. For available models to choose from, see [Change the model type](04-lemur/customize-parameters.mdx#change-the-model-type).
...
Create a custom task with LeMUR, using the transcript and prompt as input. The final model defines the LLM to use to process the task. For available models to choose from, see [Change the model type](04-lemur/customize-parameters.mdx#change-the-model-type).
...
- [Ask questions about your audio data using LeMUR](../04-lemur/ask-questions.mdx)
- [Writing good prompts](../04-lemur/improving-your-prompt.mdx)
