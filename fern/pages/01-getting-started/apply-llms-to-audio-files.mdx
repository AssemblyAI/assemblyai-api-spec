...
For more techniques on how to build prompts, see [Improving your prompt](/docs/lemur/prompt-engineering).
...
Write a prompt with instructions on how LeMUR should generate the text output. The final model defines the LLM to use to process the task. For available models to choose from, see [Change the model type](/docs/lemur/change-model-and-parameters#change-the-model-type).
...
Create a custom task with LeMUR, using the transcript and prompt as input. The final model defines the LLM to use to process the task. For available models to choose from, see [Change the model type](/docs/lemur/change-model-and-parameters#change-the-model-type).
...
- [Ask questions about your audio data using LeMUR](/docs/lemur/ask-questions-about-your-audio-data)
- [Writing good prompts](/docs/lemur/prompt-engineering)
