...
| -------------------------------------------------------- | ------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------- |
| **Model Name**                                           | **Model ID**                               | **Description**                                                                                                                                          | **Region** | **Context Window** |
| -------------------------------------------------------- | ------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- | ------------------ |
| **Claude 4 Sonnet**                                      | `aai.LemurModel.claude_sonnet_4_20250514`  | A model with enhanced reasoning and improved performance for everyday tasks while maintaining exceptional speed and cost-effectiveness.                  | US & EU    | 200k               |
| **Claude 4 Opus**                                        | `aai.LemurModel.claude_opus_4_20250514`    | Anthropic's most capable model yet, offering superior performance on complex reasoning tasks, advanced creative work, and sophisticated problem-solving. | US only    | 200k               |
| **Claude 3.7 Sonnet**                                    | `aai.LemurModel.claude3_7_sonnet_20250219` | A advanced model featuring enhanced reasoning capabilities. Strong at complex reasoning tasks.                                                           | US & EU    | 200k               |
| **Claude 3.5 Sonnet**                                    | `aai.LemurModel.claude3_5_sonnet`          | A mid-tier upgrade balancing power and performance. This uses Anthropic's Claude 3.5 Sonnet model version `claude-3-5-sonnet-20240620`.                  | US & EU    | 200k               |
| **Claude 3.5 Haiku**                                     | `aai.LemurModel.claude3_5_haiku_20241022`  | The fastest model in the family, optimized for quick responses while maintaining good reasoning.                                                         | US & EU    | 200k               |
| **Claude 3.0 Opus**                                      | `aai.LemurModel.claude3_opus`              | The most powerful legacy Claude 3 model, excels at complex writing and analysis.                                                                         | US only    | 200k               |
| **Claude 3.0 Haiku**                                     | `aai.LemurModel.claude3_haiku`             | An entry-level, fast legacy model for everyday tasks.                                                                                                    | US only    | 200k               |
| **Claude 3.0 Sonnet** (*Legacy - Sunsetting on 7/21/25*) | `aai.LemurModel.claude3_sonnet`            | A legacy mid-tier model balancing power and speed.                                                                                                       | US only    | 200k               |
...
You can feed in up to a maximum of 100 hours of audio.
