...
const result = await axios.post(base_url + "/lemur/v3/generate/summary", lemur_data, { headers });
...
<Card icon="book" title="Cookbook: Custom summary with LeMUR Task" href="https://www.assemblyai.com/docs/guides/task-endpoint-custom-summary"/>
