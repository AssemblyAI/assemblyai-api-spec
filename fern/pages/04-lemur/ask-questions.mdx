...
result = transcript.lemur.task(prompt, final_model=aai.LemurModel.anthropic/claude-3-7-sonnet-20250219)
...
result = transcript.lemur.question(
    final_model=aai.LemurModel.anthropic/claude-3-7-sonnet-20250219,
    questions,
