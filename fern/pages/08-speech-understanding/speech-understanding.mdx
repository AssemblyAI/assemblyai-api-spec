...
Here is how you can use the Speech Understanding API to map generic speaker labels to actual speaker names.
...
The Speech Understanding API requires a previously completed transcript so the request below shows how to retrieve a completed transcript using the transcript id and how to use that completed transcript in a request to the Speech Understanding API.
