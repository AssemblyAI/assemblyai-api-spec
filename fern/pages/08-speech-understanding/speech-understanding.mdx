...
| `speaker_identification.known_values`              | array  | Optional* | List of speaker names or roles to identify in the audio.                                   |

* The `known_values` parameter is required if the value of `speaker_type` is "role".
