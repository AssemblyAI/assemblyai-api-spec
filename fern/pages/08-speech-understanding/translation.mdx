...
# Step 1: Configure and create transcriber
config = aai.TranscriptionConfig(
  speaker_labels=True  # Optional: enable speaker diarization
)
...
# Step 3: Request translation using Speech Understanding
print("Requesting translations...")
...
async function translateTranscript() {
  // Step 1: Configure and transcribe the audio
  ...
  // Step 2: Request translation using Speech Understanding
  console.log("Requesting translations...");
