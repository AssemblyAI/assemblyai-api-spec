...
From your local machine, test the connection using the live microphone example (see the [Live microphone streaming example](#live-microphone-streaming-example) section above).
