      ...
      <div className="flex flex-col h-full justify-between">
        <div className="flex flex-col gap-4 mb-auto">
          <div className="flex flex-row gap-2">
            <img
              src="../../assets/img/cookbooks/icons/speech-to-text-icon.svg"
  ...
  <Card href="guides/speaker-identification" className="cookbook-card">
    ...
    <div className="flex flex-col h-full justify-between">
      <div className="flex flex-col gap-4 mb-auto">
        <div className="flex flex-row gap-2">
          <img
            src="../../assets/img/cookbooks/icons/audio-intelligence-icon.svg"
            alt="Speech Understanding icon"
            className="mx-0"
          />
          <p>Speech Understanding</p>
        </div>
        <div className="t-default text-base font-medium">
...
<div className="card-stack">
  <Card href="guides/real_time_llm_gateway" className="cookbook-card">
    <div className="bg-noise"></div>
    <div className="flex flex-col h-full justify-between">
      <div className="flex flex-col gap-4 mb-auto">
        <div className="flex flex-row gap-2">
          <img
            src="../../assets/img/cookbooks/icons/lemur-icon.svg"
            alt="LLM Gateway icon"
            className="mx-0"
          />
          <p>LLM Gateway</p>
        </div>
        <div className="t-default text-base font-medium">
          Use LLM Gateway with Streaming Speech-to-Text
        </div>
      </div>
      <div className="flex flex-row gap-2 items-center mt-4 cta">
        <p>Build this</p>
...
<div className="guides-list">
  <ul className="no-bullets">
    ...
    <li>
      <a
        href="guides/real_time_llm_gateway"
        className="link-cta rounded-lg flex items-center gap-2"
      >
...
<div className="guides-list">
  <ul className="no-bullets">
    ...
    <li className="flex items-center gap-2">
      <a
        href="/docs/speech-understanding/summarization/summarizing-virtual-meetings"
        className="link-cta rounded-lg flex items-center gap-2"
      >
      ...
      <span className="audio-intelligence-tag">Speech Understanding</span>
    </li>
    <li className="flex items-center gap-2">
      <a
        href="/docs/speech-understanding/topic-detection/identifying-hate-speech-in-audio-or-video-files"
        className="link-cta rounded-lg flex items-center gap-2"
      >
    ...
    <li className="flex items-center gap-2">
      <a
        href="/docs/speech-understanding/key-phrases/identifying-highlights-in-audio-or-video-files"
        className="link-cta rounded-lg flex items-center gap-2"
      >
    ...
    <li className="flex items-center gap-2">
      <a
        href="/docs/speech-understanding/auto-chapters/creating-summarized-chapters-from-podcasts"
        className="link-cta rounded-lg flex items-center gap-2"
      >
    ...
    <li className="flex items-center gap-2">
      <a
        href="/docs/guides/task-endpoint-action-items"
        className="link-cta rounded-lg flex items-center gap-2"
      >
      ...
      <span className="LLM Gateway-tag">LLM Gateway</span>
    </li>
    <li className="flex items-center gap-2">
      <a
        href="/docs/guides/automatic-language-detection-separate"
        className="link-cta rounded-lg flex items-center gap-2"
      >
    ...
    <li className="flex items-center gap-2">
      <a
        ...
        className="link-cta rounded-lg flex items-center gap-2"
      >
        Process speaker labels with LLM Gateway{" "}
        <Icon
          icon="duotone arrow-right"
          color="rgba(var(--accent-aaa),var(--tw-text-opacity,1))"
        />
