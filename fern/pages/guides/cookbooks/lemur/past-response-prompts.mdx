...
<Code src="../../../../snippets/guides/cookbooks/lemur/past-response-prompts/python-1.py" />
## Getting Started
...
<Code src="../../../../snippets/guides/cookbooks/lemur/past-response-prompts/python-2.py" />
After the intitial prompt, the code will continuously prompt the user for new
prompts until they decide to stop. Stop at any time by typing 'end'. Each
response is collected in the `results_list` and added as context to the next
user prompt. This enables an ability to recall past responses and allow follow
up questions.

<Code src="../../../../snippets/guides/cookbooks/lemur/past-response-prompts/python-3.py" />
To see these results with and without the context provided from past responses,
