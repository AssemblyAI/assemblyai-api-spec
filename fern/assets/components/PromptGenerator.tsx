...
What helps:
- Start with transcription (Massive impact): e.g., "Transcribe this audio", "Transcribe verbatim" - Model has transcribe prompts in its training data, focuses the prompt
...
Capability reliability levels:
- Verbatim transcription and disfluencies: High
- Output style and formatting: High
- Context aware clues: Medium
- Entity accuracy and spelling: Medium
- Speaker attribution: Experimental (YMMV) - Speaker attribution generated by the model are in addition to the speaker diarization feature. We recommend using one or the other. Using the word "speaker" anywhere in the prompt will generate labels so avoid this word to ensure this capability is not activated.
- Audio event tags: Experimental (YMMV)
- Code-switching and multilingual: Medium
- Numbers and measurements: Medium
- Difficult audio handling: Experimental (YMMV)
